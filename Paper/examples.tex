...
\begin{figure}[htbp]
 \begin{center}
  ...
  \caption{Plotted above is the solution, $u(x,y)$ of~\eqref{eq:semilinear} at fixed values
  of $\kappa$, $c$, and $\alpha_i$ as provided. The color-bar indicates the range of $u$.}
\label{fig:usoln}
\end{center}
\end{figure}
