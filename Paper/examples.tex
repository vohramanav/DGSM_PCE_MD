...
the PCE using 50 training points was found to be 3, 2,and 2 in the 4D, 5D, and 7D case respectively;
...
order PCE becomes more accurate. Note that the same set of 50 samples in the
...
The gains are expected to increase exponentially as the dimensionality of the 
...
\end{figure}
%
\rebut{The comparison of convergence characteristics of $\epsilon_{\mbox{\tiny{L-2}}}$
illustrated in Figure~\ref{fig:conv_elliptic}(b) indicates that for a small sample size of 20,
the surrogate constructed in the reduced space performs better in terms of
predictability. However, as the sample size increases, the full space is observed to
be slightly more accurate. However, the order of the accuracy is found to be 
