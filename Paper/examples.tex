...
parameters in the borehole function. The indices are estimated using 10$^6$ pseudo-random
samples in the input parameter domain. 

We now shift our focus on assessing the relative importance of the uncertain parameters by
estimating $\hat{\mathcal{C}_i\mu_i}$ using Eqs.~\ref{eq:mu} and \ref{eq:cmu}.
