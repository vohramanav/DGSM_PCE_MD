...
\alennote{1. Remove $G^M$; use $G$ and $G^{PC}$. 2. Start with $G$ in $\xi$ and
the, in one sentence connect to physical range. 3. Equation (9) should be moved up to 
2.1.}
...
%As discussed earlier in Section~\ref{sec:intro}, the 
