...
\multicolumn{1}{ |l|| }{\textbf{DGSM-based}, 
$\widehat{\mathcal{C}_i\mu_i}$} & \centering 100 + $N_{v_1}$ & \hspace{13mm} 170 + $N_{v_1}$ \\ 
\cline{1-3}
\multicolumn{1}{ |l|| }{\textbf{Total-effect Sobol'}, $\mathcal{T}(\theta_i)$} & \centering 20 + $N_{v_2}$ & 
