...
can be as expensive as computing the Sobol indices via sampling. This is
clearly a ``catch-22" situation. In this paper, we aim to address this
problem in a systematic and efficient manner. Specifically, we reduce
...
screening metric is tested successively. Moreover, the verification steps built
