...
We begin by setting aside computational resources for constructing a 
...
evaluations are available. Accuracy of the surrogate could be further investigated by comparing
probability density functions (PDFs) of the model output based on model evaluations in the full
parameter space and surrogate predictions corresponding to a large number of samples.  
