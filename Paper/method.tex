...
\alennote{I don't think you can construct the PDF in full parameter 
space, in real applications, as you need a large number of 
expensive model evaluations. Maybe we should say that  
we compare the PDF of the surrogate to a histogram of true model
evaluations?}
