...
An initial set of say, $n_1$ samples is used to obtain a rough estimate
of the metric.  
...
implementing the present framework. Additionally, in some cases, the partial
...
expected to increase by a factor, $N_p+1$; $N_p$ being the number of inputs. 
A possible, more efficient alternative to FD involves the use of adjoints for
