...
$\mathcal{T}(\theta_i)$ in each case in the legend; and (c) Estimates of
...
samples used for approximating $\mu_i$ using~\eqref{eq:mu}. Additionally,
...
used for constructing the PCE in 4, 5, and 7 dimensions. The degree of
...
However, the plot of $\epsilon_{\mbox{\tiny{L-2}}}$ as a function of sample
...
\end{figure}
%
The comparison of predictive accuracy of the PCEs using $\epsilon_{\mbox{\tiny{L-2}}}$
