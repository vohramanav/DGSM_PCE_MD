...
In the borehole test case, the degree of the PCE was found to be 3 in the reduced space (4D)
and 5 in the full space (7D). In the case of semilinear elliptic PDE, the degree of the PCE was 
found to be 3 in the reduced space (5D) as well as the original space (10D). For the reaction
kinetics application, the degree of the PCE was found to be 3 in the reduced space (4D) and 
2 in the full space (19D). 
...
reasonably approximates the screening metric. The is also observed in
...
of $\epsilon_{L_2}$ have been included for the numerical tests presented in Section 3 and 
the chemical kinetics application presented in Section 4. 
