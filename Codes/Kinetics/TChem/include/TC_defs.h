...
/** \var static int TC_nPlogReac_
 *  \ingroup noreac
    \brief # of PLOG reactions */
static int TC_nPlogReac_     ;
...
static double TC_TthrmMin_, TC_TthrmMax_ ;
...
/* PLOG reactions */
static int    *TC_reacPlogIdx_  ;
static int    *TC_reacPlogPno_  ;
static double *TC_reacPlogPars_ ;

/* Other work arrays */
static double *TC_kfor, *TC_krev, *TC_kforP, *TC_krevP, *TC_kforPder, *TC_krevPder, *TC_ropFor, *TC_ropRev, *TC_rop;
...
static double *qfr ;
static double *TC_y2x2y ;
static double *TC_entr  ;
...
int TC_getEntr0SpecMlFcn(double t, double *ei);
