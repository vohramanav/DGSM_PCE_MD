...
\scriptsize{Collaborators: Alen Alexanderian$^{\S}$, Cosmin Safta$^{\ddag}$}}
\vspace{-1mm}
\institute{$^{\dag}$Vanderbilt University\\ \vspace{1mm}
$^{\S}$North Carolina State University \\ \vspace{1mm}
$^{\ddag}$Sandia National Laboratories}
...
\epsilon_{val} = \frac{\left[\sum_{i=1}^{N}\left(\mathcal{M}(\bm{x}^{(i)}) - 
\mathcal{M}^{PCE}(\bm{x}^{(i)})\right)^{2}\right]^{\frac{1}{2}}}{\left[\sum_{i=1}^{N}
\left(\mathcal{M}(\bm{x}^{(i)})\right)^2\right]^{\frac{1}{2}}} \approx 8.35\times10^{-2}
\nonumber
\ee
...
\subsection{elliptic}
\begin{frame}{Semi-linear Elliptic PDE}
...
\begin{align}
-\kappa \Delta u + cu^3 &= q,~\text{in}~\Omega \nonumber \\
...
\scriptsize
\be
q = 8\sum\limits_{i=1}^{N=8}a_i\sin\left(\frac{i\pi x}{8}\right)\cos\left(\frac{i\pi y}{8}\right)
\nonumber
\ee
...
\begin{tabular}{|c||c|}
\hline
\textbf{Parameter} & \textbf{Distribution} \\ \hline \hline
\scriptsize
$\kappa$ & $\mathcal{U}$[0.05,0.1] \\
$c$ & $\mathcal{U}$[1.0,2.0] \\
$a_i$ & $\mathcal{U}$[0.0,0.5] \\
\hline
\end{tabular}
\end{center}
\end{table}
...
\begin{center}
\tiny{Sobol total-effect index}
\vspace{-2mm}
 \begin{figure}[htbp]
 \vspace{-2mm}
   \includegraphics[width=0.75\textwidth]{./Figures/sens_elliptic}
   \\ \vspace{2mm} \tiny{Convergence characteristics} \\ 
...
%%___________________________NEW SLIDE______________________________________
%
\section{\scshape Kinetics}
\subsection{kinetics}
\begin{frame}{H$_2$/O$_2$ Reaction Mechanism}

\begin{columns}
\begin{column}{0.65\textwidth}
\begin{itemize}

\myitem Reactions rates:
\be
k = AT^{n}\exp(-E_a/RT) \nonumber
\ee
\vspace{-2mm}
\scriptsize{$k$: Reaction rate, $A$: Pre-Exponent\\ \vspace{1mm} $E_a$: Activation Energy}
\normalsize

\vspace{3mm}
\myitem Uniform prior marginals:
\be
A_i \sim \mathcal{U}[0.9A_{i,\mbox{\tiny{nom}}},1.1A_{i,\mbox{\tiny{nom}}}] \nonumber
\ee
\vspace{-2mm}
\scriptsize{\hspace{-5mm}$A_{i,\mbox{\tiny{nom}}}$: Nominal value of the $i^{\mbox{th}}$ Pre-Exponent}
\normalsize
\vspace{3mm}

\myitem QoI: Ignition Delay 
...
\tiny{
\begin{enumerate}
\item H + O$_2$ $\Longleftrightarrow$ O + OH 
\item O + H$_2$ $\Longleftrightarrow$ H + OH 
\item H$_2$ + OH $\Longleftrightarrow$ H$_2$O + H 
\item OH + OH $\Longleftrightarrow$ O + H$_2$O 
\item H$_2$ + M $\Longleftrightarrow$ H + H + M 
\item O + O + M $\Longleftrightarrow$ O$_2$ + M 
\item O + H + M $\Longleftrightarrow$ OH + M 
\item H + OH +M $\Longleftrightarrow$ H$_2$O + M 
\item H + O$_2$ + M $\Longleftrightarrow$ HO$_2$ + M 
\item HO$_2$ + H $\Longleftrightarrow$ H$_2$ + O$_2$ 
\item HO$_2$ + H $\Longleftrightarrow$ OH + OH 
\item HO$_2$ + O $\Longleftrightarrow$ O$_2$ + OH 
\item HO$_2$ + OH $\Longleftrightarrow$ H$_2$O + O$_2$ 
\item HO$_2$ + HO$_2$ $\Longleftrightarrow$ H$_2$O$_2$ + O$_2$ 
\item H$_2$O$_2$ + M $\Longleftrightarrow$ OH + OH + M
\item H$_2$O$_2$ + H $\Longleftrightarrow$ H$_2$O + OH
\item H$_2$O$_2$ + H $\Longleftrightarrow$ HO$_2$ + H$_2$
\item H$_2$O$_2$ + O $\Longleftrightarrow$ OH + HO$_2$
\item H$_2$O$_2$ + OH $\Longleftrightarrow$ HO$_2$ + H$_2$O
...
%
\subsection{kinetics}
\begin{frame}{Sensitivity Measures}
...
\tiny Lean Mixture
 \begin{figure}[htbp]
   \includegraphics[width=0.95\textwidth]{./Figures/ub_conv_kinetics_lean}
\end{figure}
\end{center}
...
\tiny Rich Mixture
 \begin{figure}[htbp]
   \includegraphics[width=0.95\textwidth]{./Figures/ub_conv_kinetics_rich}
\end{figure}
\end{center}
...
Relative L-2 norm of the error:
\scriptsize{
%\be
\bea
\varepsilon_{\mbox{\tiny{L-2}}} &=& \frac{\left[\sum_{i=1}^{N}\left(\mathcal{M}(\bm{x}_{\mbox{\tiny{19D}}}^{(i)}) - 
\mathcal{M}^{PCE}(\bm{x}_{\mbox{\tiny{2D}}}^{(i)})\right)^{2}\right]^{\frac{1}{2}}}{\left[\sum_{i=1}^{N}
\left(\mathcal{M}(\bm{x}_{\mbox{\tiny{19D}}}^{(i)})\right)^2\right]^{\frac{1}{2}}} \nonumber \\
&\approx& \mathcal{O}(10^{-2})
\nonumber
\eea
%\ee
}
...
\begin{center}
 \begin{figure}[htbp]
\tiny Lean Mixture \\
   \includegraphics[width=0.85\textwidth]{./Figures/pdf_comp_kinetics_lean}
\\ \vspace{2mm} \tiny Rich Mixture \\
   \includegraphics[width=0.85\textwidth]{./Figures/pdf_comp_kinetics_rich}
...
\begin{column}{0.5\textwidth}
\begin{itemize}
\myitem Relative L-2 norm of the error:

\scriptsize{
\begin{eqnarray}
\epsilon_{\mbox{\tiny{L-2}}} &=& \frac{\left[\sum_{i=1}^{N}\left(\mathcal{M}(\bm{x}_{\mbox{\tiny{19D}}}^{(i)}) - 
\mathcal{M}^{PCE}(\bm{x}_{\mbox{\tiny{2D}}}^{(i)})\right)^{2}\right]^{\frac{1}{2}}}{\left[\sum_{i=1}^{N}
\left(\mathcal{M}(\bm{x}_{\mbox{\tiny{19D}}}^{(i)})\right)^2\right]^{\frac{1}{2}}} \nonumber \\ 
&\approx& 3.35\times10^{-2}
\nonumber
\end{eqnarray}
}
...
\begin{column}{0.5\textwidth}
 ...
 \begin{figure}[htbp]
   \includegraphics[width=0.8\textwidth]{./Figures/pdf_comp_kinetics_lean}
   \\ \scriptsize{Lean Mixture}
\end{figure}
