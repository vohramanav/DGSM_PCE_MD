...
\begin{frame}{Derivative-based Sensitivity Measures}
 ...
 \begin{figure}[htbp]
   \includegraphics[width=0.75\textwidth]{./Figures/ub_conv_kinetics}
\end{figure}
...
\be
\epsilon_{val} = \frac{\left[\sum_{i=1}^{N}\left(\mathcal{M}(\bm{x}_{\mbox{\tiny{19D}}}^{(i)}) - 
\mathcal{M}^{PCE}(\bm{x}_{\mbox{\tiny{2D}}}^{(i)})\right)^{2}\right]^{\frac{1}{2}}}{\left[\sum_{i=1}^{N}
\left(\mathcal{M}(\bm{x}_{\mbox{\tiny{19D}}}^{(i)})\right)^2\right]^{\frac{1}{2}}} \approx 3.35\times10^{-2}
\nonumber
\ee
